...
pixi add cuda-cuxxfilt
# for installing globally
pixi global install cuda-cuxxfilt
```
...
It is possible to list all of the versions of `cuda-cuxxfilt` available on your platform:
...
```
pixi search cuda-cuxxfilt --channel conda-forge
```
